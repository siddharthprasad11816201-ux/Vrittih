...
**Purpose:** Prisma schema, models, relations, migrations (sqlite local / postgres prod).

**Scope:** All specifications, contracts and implementation notes for this domain.

**Owner:** siddharthprasad (solo)

**Implementation status:** ✅ (dual provider)
...
**Related documents:** See prisma/schema.prisma + ../ERD in specs · [/docs/README.md](../README.md) · [/docs/ROADMAP.md](../ROADMAP.md) · [/docs/IMPLEMENTATION_TRACKER.md](../IMPLEMENTATION_TRACKER.md)
