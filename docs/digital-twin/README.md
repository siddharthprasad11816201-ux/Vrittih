# Enterprise Digital Twin — Documentation

**Purpose:** Org/employee/project/learning twins + simulation engine.
...
**Dependencies:** Talent Graph, Simulation
...
**Related documents:** ENTERPRISE_DIGITAL_TWIN_PLATFORM.md · [/docs/README.md](../README.md) · [/docs/ROADMAP.md](../ROADMAP.md) · [/docs/IMPLEMENTATION_TRACKER.md](../IMPLEMENTATION_TRACKER.md)
