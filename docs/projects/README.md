...
**Purpose:** Projects, milestones, kanban, portfolio, wiki + AI Project Manager.

**Scope:** All specifications, contracts and implementation notes for this domain.

**Owner:** siddharthprasad (solo)

**Implementation status:** EPCOS ✅

**Dependencies:** lib/project/*, Enterprise Brain
...
**Related documents:** EPCOS_COMPLETION_REPORT.md · [/docs/README.md](../README.md) · [/docs/ROADMAP.md](../ROADMAP.md) · [/docs/IMPLEMENTATION_TRACKER.md](../IMPLEMENTATION_TRACKER.md)
