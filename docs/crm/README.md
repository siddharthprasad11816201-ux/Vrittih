...
**Purpose:** Deals pipeline, campaigns, support + AI Sales Assistant.
...
**Dependencies:** lib/crm/revenue.ts, Enterprise Brain
...
**Related documents:** ENTERPRISE_CRM_PLATFORM.md · [/docs/README.md](../README.md) · [/docs/ROADMAP.md](../ROADMAP.md) · [/docs/IMPLEMENTATION_TRACKER.md](../IMPLEMENTATION_TRACKER.md)
