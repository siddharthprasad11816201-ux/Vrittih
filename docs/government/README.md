# Government Platform — Documentation

**Purpose:** Citizen services, schemes, grievances, budgets + Policy Intelligence.

**Scope:** All specifications, contracts and implementation notes for this domain.

**Owner:** siddharthprasad (solo)

**Implementation status:** Models staged; not built
...
**Related documents:** ENTERPRISE_GOVERNMENT_PLATFORM.md · [/docs/README.md](../README.md) · [/docs/ROADMAP.md](../ROADMAP.md) · [/docs/IMPLEMENTATION_TRACKER.md](../IMPLEMENTATION_TRACKER.md)
