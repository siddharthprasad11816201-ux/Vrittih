...
export const CAPABILITIES: CapabilitySeed[] = [
  ...
  // AI Career Coach — role readiness + gap + learning plan via the brain (Individual Experience).
  { capId: "career.coach.readiness", name: "AI Career Coach — role readiness + learning plan", provider: "career.coach.readiness", modelId: "enterprise-brain-v1", safetyClass: "standard", permissions: ["auth"] },
]
