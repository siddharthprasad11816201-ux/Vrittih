            ...
            <div style="font-family:-apple-system,sans-serif;max-width:560px;margin:0 auto;padding:32px 24px;background:#F8F8FC;border-radius:16px">
              <div style="background:#fff;border-radius:12px;padding:28px;border:1px solid rgba(0,0,0,.08)">
                <div style="display:flex;align-items:center;gap:10px;margin-bottom:20px">
                  <div style="width:36px;height:36px;background:#534AB7;border-radius:9px;display:flex;align-items:center;justify-content:center">
                ...
                ${payload.link ? `<a href="${appUrl}${payload.link}" style="display:inline-block;background:#534AB7;color:#fff;padding:10px 22px;border-radius:8px;font-size:14px;font-weight:500;text-decoration:none">View update</a>` : ""}
                <hr style="margin:24px 0;border:none;border-top:1px solid rgba(0,0,0,.07)" />
                <p style="font-size:12px;color:#9ca3af;margin:0">You received this because you have a Vrittih account. <a href="${appUrl}/settings" style="color:#534AB7">Manage notifications</a></p>
              </div>
            </div>
          `,
        })
