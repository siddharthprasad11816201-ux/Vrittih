...
export default function NotificationsPage() {
  ...
  function getIcon(title: string) {
    ...
    if (t.includes("application") || t.includes("applied")) return { icon: <IconFileText size={17} />, color: "#6495ED" }
...
const S: Record<string,any> = {
  ...
  btn: { background:"#6495ED", color:"#fff", border:"none", borderRadius:8, padding:"8px 16px", fontSize:13, fontWeight:500, cursor:"pointer" },
  ...
  filterOn: { background:"#6495ED", color:"#fff", border:"0.5px solid #6495ED", fontWeight:500 },
  ...
  dot: { width:8, height:8, borderRadius:"50%", background:"#6495ED" },
