...
export default function ResumeBuilder() {
  ...
  const accentColor = template === "modern" ? "#7C3AED" : template === "minimal" ? "#0A0A0F" : "#1E40AF"
...
const S: Record<string,any> = {
  ...
  templateBtnOn:{ background:"#7C3AED",color:"#fff",fontWeight:500 },
  downloadBtn:{ background:"#7C3AED",color:"#fff",border:"none",borderRadius:9,padding:"9px 18px",fontSize:13,fontWeight:500,cursor:"pointer" },
