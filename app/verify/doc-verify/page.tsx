            ...
            <div>
              ...
              <div style={S.uploadZone}>
                ...
                <label htmlFor="doc-upload" style={S.uploadLabel}>
                  <span style={{color:"#6495ED"}}><IconFileText size={34} /></span>
...
const S: Record<string,any> = {
  page:{minHeight:"calc(100vh - 60px)",background:"#F7F9FC",padding:"2rem",display:"flex",justifyContent:"center"},
  ...
  extracting:{background:"#EAF1FE",border:"0.5px solid rgba(15,110,86,.2)",borderRadius:8,padding:"10px 14px",fontSize:13,color:"#6495ED",display:"flex",gap:8,alignItems:"center",marginBottom:12},
  ...
  scoreCard:{background:"#EAF1FE",border:"0.5px solid rgba(15,110,86,.2)",borderRadius:12,padding:"1rem 1.5rem",textAlign:"center" as const},
  scoreNum:{fontSize:28,fontWeight:700,color:"#6495ED"},
