            ...
            <div>
              ...
              <div style={S.uploadZone}>
                ...
                <label htmlFor="doc-upload" style={S.uploadLabel}>
                  <span style={{color:"#0F6E56"}}><IconFileText size={34} /></span>
...
const S: Record<string,any> = {
  ...
  extracting:{background:"#E1F5EE",border:"0.5px solid rgba(15,110,86,.2)",borderRadius:8,padding:"10px 14px",fontSize:13,color:"#0F6E56",display:"flex",gap:8,alignItems:"center",marginBottom:12},
  ...
  scoreCard:{background:"#E1F5EE",border:"0.5px solid rgba(15,110,86,.2)",borderRadius:12,padding:"1rem 1.5rem",textAlign:"center" as const},
  scoreNum:{fontSize:28,fontWeight:700,color:"#0F6E56"},
