...
function TwoFAContent() {
  ...
  return (
    <div style={S.page}>
      <div style={S.card}>
        <div style={{...S.icon,color:"#6495ED",display:"flex",justifyContent:"center"}}><IconLock size={42} /></div>
        <h1 style={S.title}>
...
export default function TwoFAPage() {
  return (
    <Suspense fallback={<div style={{display:"flex",alignItems:"center",justifyContent:"center",minHeight:"100vh",background:"#0B1126",color:"#fff",fontSize:14}}>Loading...</div>}>
      <TwoFAContent />
    </Suspense>
  )
}
...
const S: Record<string,any> = {
  ...
  otpInputFilled:{ borderColor:"#6495ED",boxShadow:"0 0 0 3px rgba(15,110,86,.1)" },
  verifyBtn:{ width:"100%",background:"#6495ED",color:"#fff",border:"none",borderRadius:10,padding:"12px",fontSize:15,fontWeight:600,cursor:"pointer",marginBottom:"1rem" },
  resend:{ marginBottom:"1rem" },
  resendBtn:{ background:"none",border:"none",color:"#6495ED",fontSize:13,fontWeight:500,cursor:"pointer" },
