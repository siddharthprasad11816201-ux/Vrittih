                        ...
                        {q.options.map((opt, oi) => (
                          <div key={oi} style={S.optRow}>
                            <input type="radio" name={`correct-${qi}`} checked={q.correctAnswer === opt && opt !== ""}
                              ...
                              style={{accentColor:"#6495ED",flexShrink:0}} />
...
const S: Record<string,any> = {
  ...
  addQBtn:{ background:"#6495ED",color:"#fff",border:"none",borderRadius:8,padding:"7px 14px",fontSize:13,fontWeight:500,cursor:"pointer" },
  addQBtnLarge:{ width:"100%",background:"#EAF1FE",color:"#6495ED",border:"1px dashed rgba(15,110,86,.3)",borderRadius:10,padding:"12px",fontSize:13,fontWeight:500,cursor:"pointer",marginTop:8 },
  ...
  qNum:{ fontSize:13,fontWeight:700,color:"#6495ED",background:"#EAF1FE",padding:"4px 10px",borderRadius:999,flexShrink:0 },
  ...
  qTypeTabOn:{ background:"#6495ED",color:"#fff",border:"0.5px solid #6495ED" },
  ...
  saveBtn:{ flex:1,background:"#6495ED",color:"#fff",border:"none",borderRadius:9,padding:"12px",fontSize:14,fontWeight:600,cursor:"pointer" },
