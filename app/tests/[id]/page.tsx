          ...
          <div style={S.introStats}>
            {[
              ...
              <div key={item.label} style={S.statItem}>
                <span style={{color:"#6495ED"}}>{item.icon}</span>
                <div>
          ...
          {q.type === "CODING" && (
            <div>
              ...
              <textarea
                ...
                style={{...S.shortAnswer, fontFamily:"monospace", background:"#0B1126", color:"#9FD4C3", fontSize:13}}
                rows={10}
              />
            </div>
          )}
    ...
    <AppShell>
      <div style={S.page}>
        <div style={S.resultCard}>
          <div style={{marginBottom:16,color:result.passed===true?"#059669":result.passed===false?"#B45309":"#6495ED"}}>
          ...
          <div style={S.scoreCircle}>
            <div style={{fontSize:40,fontWeight:700,color:result.passed===true?"#059669":result.passed===false?"#DC2626":"#6495ED"}}>{result.score}%</div>
...
const S: Record<string,any> = {
  ...
  page:{ background:"#F7F9FC",minHeight:"calc(100vh - 60px)",padding:"2rem",display:"flex",justifyContent:"center" },
  ...
  introIcon:{ marginBottom:12,color:"#6495ED",display:"flex",justifyContent:"center" },
  ...
  timer:{ fontSize:16,fontWeight:700,color:"#6495ED",fontVariantNumeric:"tabular-nums" as const },
  timerWarn:{ color:"#DC2626" },
  qCount:{ fontSize:13,color:"#9ca3af" },
  tabWarn:{ fontSize:12,color:"#DC2626",fontWeight:500 },
  submitBtn:{ background:"#6495ED",color:"#fff",border:"none",borderRadius:8,padding:"8px 18px",fontSize:13,fontWeight:500,cursor:"pointer",marginLeft:12 },
  progressWrap:{ height:3,background:"#E5E7EB",flexShrink:0 },
  progressFill:{ height:3,background:"#6495ED",transition:"width .3s" },
  ...
  optionSelected:{ border:"1.5px solid #6495ED",background:"#EAF1FE",color:"#6495ED" },
  ...
  navBtnPrimary:{ background:"#6495ED",color:"#fff",border:"none",borderRadius:8,padding:"8px 18px",fontSize:13,fontWeight:500,cursor:"pointer" },
  ...
  qNavCurrent:{ border:"1.5px solid #6495ED",background:"#EAF1FE",color:"#6495ED",fontWeight:600 },
