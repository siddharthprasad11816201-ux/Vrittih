        ...
        <div style={S.mailList}>
          ...
          mails.length === 0 ? (
            ...
            <div key={m.id} onClick={() => openMail(m)} style={{...S.mailItem,...(selected?.id===m.id?S.mailItemOn:{})}}>
              <div style={{...S.mailAvatar,background:"#7C3AED"}}>{initials(folder==="sent"?m.to?.name:m.from?.name)}</div>
          ...
          {selected && !composing && (
            <div style={S.readMail}>
              ...
              <div style={S.readMeta}>
                <div style={{...S.mailAvatar,width:36,height:36,fontSize:13,background:"#7C3AED"}}>{initials(selected.from?.name)}</div>
                <div>
...
const S: Record<string,any> = {
  ...
  composeBtn:{ background:"#7C3AED",color:"#fff",border:"none",borderRadius:10,padding:"10px 14px",fontSize:13,fontWeight:600,cursor:"pointer",marginBottom:8,textAlign:"left" as const },
  ...
  folderBtnOn:{ background:"#F5F3FF",color:"#7C3AED",fontWeight:500 },
  badge:{ background:"#7C3AED",color:"#fff",borderRadius:999,fontSize:10,fontWeight:700,padding:"1px 6px",minWidth:18,textAlign:"center" as const },
  ...
  unreadDot:{ width:7,height:7,borderRadius:"50%",background:"#7C3AED",flexShrink:0 },
  ...
  sendBtn:{ background:"#7C3AED",color:"#fff",border:"none",borderRadius:8,padding:"9px 20px",fontSize:13,fontWeight:500,cursor:"pointer" },
  ...
  replyBtn:{ background:"#7C3AED",color:"#fff",border:"none",borderRadius:8,padding:"6px 14px",fontSize:13,fontWeight:500,cursor:"pointer" },
