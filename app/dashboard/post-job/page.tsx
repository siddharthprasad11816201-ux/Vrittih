          ...
          <form onSubmit={submit}>
            ...
            <div style={S.section}>
              ...
              <div style={S.checkRow}>
                <input type="checkbox" id="remote" checked={form.remote} onChange={e=>setForm(p=>({...p,remote:e.target.checked}))} style={{accentColor:"#7C3AED"}} />
...
const S: Record<string,any> = {
  ...
  addSkillBtn:{ background:"#7C3AED",color:"#fff",border:"none",borderRadius:8,padding:"9px 16px",fontSize:13,cursor:"pointer",flexShrink:0 },
  skillTags:{ display:"flex",flexWrap:"wrap" as const,gap:8 },
  skillTag:{ background:"#F5F3FF",color:"#7C3AED",border:"0.5px solid rgba(124,58,237,.2)",borderRadius:999,padding:"5px 12px",fontSize:13,fontWeight:500,display:"flex",alignItems:"center",gap:6 },
  skillRemove:{ background:"none",border:"none",cursor:"pointer",fontSize:16,color:"#7C3AED",lineHeight:1,padding:0 },
  actions:{ display:"flex",gap:10 },
  submitBtn:{ flex:1,background:"#7C3AED",color:"#fff",border:"none",borderRadius:9,padding:"12px",fontSize:15,fontWeight:600,cursor:"pointer" },
