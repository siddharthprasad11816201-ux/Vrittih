...
const S: Record<string, any> = {
  ...
  barFill: { height: 8, background: "linear-gradient(90deg,#6495ED,#334EAC)", borderRadius: 5, transition: "width .5s ease" },
  ...
  logo: { width: 44, height: 44, borderRadius: 10, background: "#EAF1FE", color: ACCENT, display: "grid", placeItems: "center", flexShrink: 0 },
  ...
  chip: { display: "inline-flex", alignItems: "center", gap: 6, background: "#EAF1FE", color: "#3F369E", padding: "6px 12px", borderRadius: 999, fontSize: 13, fontWeight: 500 },
