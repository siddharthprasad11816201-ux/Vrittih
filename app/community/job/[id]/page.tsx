            ...
            <div style={S.main}>
              ...
              {!isMember && (
                <div style={S.joinPrompt}>
                  <span style={{color:"#6495ED"}}><IconMessage size={16} /></span>
...
const S: Record<string,any> = {
  ...
  jobLink:{ fontSize:13,color:"#6495ED",textDecoration:"none" },
  joinBtn:{ background:"#6495ED",color:"#fff",border:"none",borderRadius:8,padding:"8px 18px",fontSize:13,fontWeight:500,cursor:"pointer" },
  ...
  hostTag:{ fontSize:11,color:"#6495ED",fontWeight:500 },
  ...
  applyLink:{ display:"block",background:"#6495ED",color:"#fff",padding:"9px 0",borderRadius:8,fontSize:13,fontWeight:500,textDecoration:"none",textAlign:"center" as const,marginTop:8 },
}