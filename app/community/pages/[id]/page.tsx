...
const S: Record<string,any> = {
  ...
  proTitle:{ fontSize:15,color:"#6495ED",fontWeight:500,marginBottom:4 },
  badge:{ display:"inline-block",background:"#EAF1FE",color:"#6495ED",fontSize:12,padding:"3px 12px",borderRadius:999,border:"0.5px solid rgba(15,110,86,.2)",marginBottom:6 },
  ...
  followBtn:{ background:"#6495ED",color:"#fff",border:"none",borderRadius:9,padding:"9px 22px",fontSize:14,fontWeight:500,cursor:"pointer",whiteSpace:"nowrap" as const },
  followingBtn:{ background:"#EAF1FE",color:"#6495ED",border:"0.5px solid rgba(15,110,86,.2)" },
  ...
  browseBtn:{ display:"block",background:"#6495ED",color:"#fff",padding:"9px 0",borderRadius:8,fontSize:13,fontWeight:500,textDecoration:"none",textAlign:"center" as const },
}