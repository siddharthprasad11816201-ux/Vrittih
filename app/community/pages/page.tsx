...
const S: Record<string,any> = {
  ...
  myPageBtn:{ background:"#E1F5EE",color:"#0F6E56",padding:"9px 18px",borderRadius:9,fontSize:13,fontWeight:500,textDecoration:"none",border:"0.5px solid rgba(15,110,86,.2)" },
  ...
  cardTitle2:{ fontSize:13,color:"#0F6E56",fontWeight:500 },
  badge:{ background:"#E1F5EE",color:"#0F6E56",fontSize:12,padding:"3px 12px",borderRadius:999,border:"0.5px solid rgba(15,110,86,.2)" },
  ...
  followBtnOn:{ background:"#E1F5EE",color:"#0F6E56",border:"0.5px solid rgba(15,110,86,.2)" },
