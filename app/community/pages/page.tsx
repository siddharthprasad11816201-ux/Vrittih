...
const S: Record<string,any> = {
  ...
  header:{ display:"flex", flexWrap:"wrap" as const, gap:16,justifyContent:"space-between",alignItems:"flex-start",marginBottom:"1.5rem" },
  title:{ fontSize:22,fontWeight:600,color:"#0A0A0F",letterSpacing:"-.3px" },
  sub:{ fontSize:13,color:"#7B7B8F",marginTop:4,maxWidth:520 },
  createBtn:{ background:"#6495ED",color:"#fff",padding:"9px 18px",borderRadius:9,fontSize:13,fontWeight:500,textDecoration:"none" },
  myPageBtn:{ background:"#EAF1FE",color:"#6495ED",padding:"9px 18px",borderRadius:9,fontSize:13,fontWeight:500,textDecoration:"none",border:"0.5px solid rgba(15,110,86,.2)" },
  ...
  cardTitle2:{ fontSize:13,color:"#6495ED",fontWeight:500 },
  badge:{ background:"#EAF1FE",color:"#6495ED",fontSize:12,padding:"3px 12px",borderRadius:999,border:"0.5px solid rgba(15,110,86,.2)" },
  ...
  viewBtn:{ flex:1,background:"#6495ED",color:"#fff",padding:"8px 0",borderRadius:8,fontSize:13,fontWeight:500,textDecoration:"none",textAlign:"center" as const },
  ...
  followBtnOn:{ background:"#EAF1FE",color:"#6495ED",border:"0.5px solid rgba(15,110,86,.2)" },
