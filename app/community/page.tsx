...
const S: Record<string,any> = {
  ...
  spaceIcon:{ flexShrink:0,width:52,height:52,display:"flex",alignItems:"center",justifyContent:"center",background:"#EAF1FE",color:"#6495ED",borderRadius:12 },
  ...
  tag:{ background:"#EAF1FE",color:"#6495ED",fontSize:11,fontWeight:500,padding:"2px 9px",borderRadius:999 },
  ...
  joinBtnOn:{ background:"#EAF1FE",color:"#6495ED",borderColor:"rgba(15,110,86,.2)" },
