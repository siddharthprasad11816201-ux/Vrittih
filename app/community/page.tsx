...
const S: Record<string,any> = {
  ...
  spaceIcon:{ flexShrink:0,width:52,height:52,display:"flex",alignItems:"center",justifyContent:"center",background:"#F5F3FF",color:"#7C3AED",borderRadius:12 },
  ...
  tag:{ background:"#F5F3FF",color:"#7C3AED",fontSize:11,fontWeight:500,padding:"2px 9px",borderRadius:999 },
  ...
  joinBtnOn:{ background:"#F5F3FF",color:"#7C3AED",borderColor:"rgba(124,58,237,.2)" },
