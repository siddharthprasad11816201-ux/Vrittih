          ...
          <div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:2rem;background:#F8F8FC;border-radius:12px">
            <div style="background:#fff;border-radius:12px;padding:2rem;border:1px solid rgba(0,0,0,.08)">
              <div style="display:flex;align-items:center;gap:10px;margin-bottom:1.5rem">
                <div style="width:36px;height:36px;background:#0F6E56;border-radius:9px;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:700;font-size:14px">V</div>
              ...
              <div style="background:#E1F5EE;border:1px solid rgba(15,110,86,.2);border-radius:12px;padding:1.5rem;text-align:center;font-size:36px;font-weight:700;letter-spacing:10px;color:#0F6E56">${otp}</div>
