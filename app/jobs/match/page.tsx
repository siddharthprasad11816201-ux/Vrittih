...
const S: Record<string,any> = {
  ...
  browseBtn:{ background:"#6495ED",color:"#fff",padding:"9px 18px",borderRadius:9,fontSize:13,fontWeight:500,textDecoration:"none" },
  ...
  skillChip:{ background:"#EAF1FE",color:"#6495ED",fontSize:12,padding:"3px 10px",borderRadius:999,border:"0.5px solid rgba(15,110,86,.15)" },
  addSkillsBtn:{ fontSize:12,color:"#6495ED",textDecoration:"none",marginLeft:"auto",fontWeight:500 },
  ...
  filterBtnOn:{ background:"#6495ED",color:"#fff",border:"0.5px solid #6495ED",fontWeight:500 },
  ...
  jobLogo:{ width:44,height:44,borderRadius:10,background:"#6495ED",color:"#fff",display:"flex",alignItems:"center",justifyContent:"center",fontSize:14,fontWeight:700,flexShrink:0 },
  ...
  applyBtn:{ background:"#6495ED",color:"#fff",padding:"8px 18px",borderRadius:8,fontSize:13,fontWeight:500,textDecoration:"none",whiteSpace:"nowrap" as const },
