...
const S: Record<string,any> = {
  ...
  browseBtn:{ background:"#7C3AED",color:"#fff",padding:"9px 18px",borderRadius:9,fontSize:13,fontWeight:500,textDecoration:"none" },
  ...
  skillChip:{ background:"#F5F3FF",color:"#7C3AED",fontSize:12,padding:"3px 10px",borderRadius:999,border:"0.5px solid rgba(124,58,237,.15)" },
  addSkillsBtn:{ fontSize:12,color:"#7C3AED",textDecoration:"none",marginLeft:"auto",fontWeight:500 },
  ...
  filterBtnOn:{ background:"#7C3AED",color:"#fff",border:"0.5px solid #7C3AED",fontWeight:500 },
  ...
  jobLogo:{ width:44,height:44,borderRadius:10,background:"#7C3AED",color:"#fff",display:"flex",alignItems:"center",justifyContent:"center",fontSize:14,fontWeight:700,flexShrink:0 },
  ...
  applyBtn:{ background:"#7C3AED",color:"#fff",padding:"8px 18px",borderRadius:8,fontSize:13,fontWeight:500,textDecoration:"none",whiteSpace:"nowrap" as const },
