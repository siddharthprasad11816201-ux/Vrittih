...
const S: Record<string,any> = {
  ...
  jobLogo:{ width:44,height:44,borderRadius:10,background:"#0F6E56",color:"#fff",display:"flex",alignItems:"center",justifyContent:"center",fontSize:14,fontWeight:700,flexShrink:0 },
  ...
  applyBtn:{ background:"#0F6E56",color:"#fff",padding:"8px 18px",borderRadius:8,fontSize:13,fontWeight:500,textDecoration:"none",whiteSpace:"nowrap" as const },
