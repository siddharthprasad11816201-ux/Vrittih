        ...
        <main>
          {!loading && weakProfile && (
            <div style={{ display:"flex", alignItems:"center", gap:14, background:"linear-gradient(135deg,#F4F1FE,#EEF2FF)", border:"1px solid #E2DBFB", borderRadius:14, padding:"14px 18px", marginBottom:16 }}>
              <div style={{ width:38, height:38, borderRadius:10, background:"#7C3AED", color:"#fff", display:"grid", placeItems:"center", flexShrink:0 }}>
                <IconTarget size={19} />
              </div>
              <div style={{ flex:1 }}>
              ...
              <Link href="/profile/edit" style={{ background:"#7C3AED", color:"#fff", fontSize:13, fontWeight:600, padding:"9px 16px", borderRadius:9, textDecoration:"none", whiteSpace:"nowrap" }}>Complete profile</Link>
            </div>
          )}
