...
const S: Record<string, any> = {
  ...
  badge: { background: "#6495ED", color: "#fff", fontSize: 11, fontWeight: 700, letterSpacing: ".06em", padding: "5px 12px", borderRadius: 999 },
  ...
  tabOn: { color: "#6495ED", fontWeight: 600, borderBottom: "2px solid #6495ED" },
  ...
  btn: { background: "#F3F0FF", color: "#334EAC", border: "none", borderRadius: 6, padding: "4px 10px", fontSize: 11, cursor: "pointer", fontWeight: 500 },
  btnAlt: { background: "#0B1126", color: "#fff", border: "none", borderRadius: 6, padding: "4px 10px", fontSize: 11, cursor: "pointer", fontWeight: 500 },
  ...
  saveBtn: { background: "#6495ED", color: "#fff", border: "none", padding: "9px 20px", borderRadius: 8, fontSize: 13, fontWeight: 500, cursor: "pointer", marginTop: 16 },
