...
const S: Record<string,any> = {
  ...
  sidebar:{ background:"#04342C",display:"flex",flexDirection:"column" as const },
  ...
  gwCardActive:{ border:"1.5px solid #0F6E56",background:"rgba(15,110,86,.02)" },
  ...
  activeBadge:{ background:"#0F6E56",color:"#fff",fontSize:11,fontWeight:600,padding:"3px 10px",borderRadius:999 },
  ...
  btnPrimary:{ background:"#0F6E56",color:"#fff",border:"none",borderRadius:8,padding:"7px 14px",fontSize:13,fontWeight:500,cursor:"pointer" },
