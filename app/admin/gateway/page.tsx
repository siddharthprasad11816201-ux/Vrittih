...
const S: Record<string,any> = {
  ...
  sidebar:{ background:"#0B1126",display:"flex",flexDirection:"column" as const },
  ...
  gwCardActive:{ border:"1.5px solid #6495ED",background:"rgba(15,110,86,.02)" },
  ...
  activeBadge:{ background:"#6495ED",color:"#fff",fontSize:11,fontWeight:600,padding:"3px 10px",borderRadius:999 },
  ...
  btnPrimary:{ background:"#6495ED",color:"#fff",border:"none",borderRadius:8,padding:"7px 14px",fontSize:13,fontWeight:500,cursor:"pointer" },
