...
const S: Record<string,any> = {
  ...
  gwCardActive:{ border:"1.5px solid #7C3AED",background:"rgba(124,58,237,.02)" },
  ...
  activeBadge:{ background:"#7C3AED",color:"#fff",fontSize:11,fontWeight:600,padding:"3px 10px",borderRadius:999 },
  ...
  btnPrimary:{ background:"#7C3AED",color:"#fff",border:"none",borderRadius:8,padding:"7px 14px",fontSize:13,fontWeight:500,cursor:"pointer" },
