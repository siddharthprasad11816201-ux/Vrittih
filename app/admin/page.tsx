...
export default function AdminDashboard() {
  ...
  const STATS = [
    { label:"Total users", value:stats.totalUsers, sub:`${stats.paidUsers} paid`, color:"#0F6E56" },
    ...
    { label:"Messages", value:stats.totalMessages, sub:"sent total", color:"#0F6E56" },
  ]
              ...
              <tbody>
                {stats.recentUsers.map((u: any)=>(
                  <tr key={u.id}>
                    ...
                    <td style={S.td}><span style={{...S.pill, background:u.role==="ADMIN"?"#FEF3C7":u.role==="EMPLOYER"?"#EFF4FF":"#E1F5EE", color:u.role==="ADMIN"?"#92400E":u.role==="EMPLOYER"?"#1D4ED8":"#0F6E56"}}>{u.role}</span></td>
...
const S: Record<string,any> = {
  ...
  brandMark: { width:32, height:32, borderRadius:9, background:"#0F6E56", display:"flex", alignItems:"center", justifyContent:"center", fontSize:16 },
  ...
  panelLink: { fontSize:12, color:"#0F6E56", textDecoration:"none" },
