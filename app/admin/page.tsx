...
export default function AdminDashboard() {
  ...
  const STATS = [
    { label:"Total users", value:stats.totalUsers, sub:`${stats.paidUsers} paid`, color:"#6495ED" },
    ...
    { label:"Messages", value:stats.totalMessages, sub:"sent total", color:"#6495ED" },
  ]
              ...
              <tbody>
                {stats.recentUsers.map((u: any)=>(
                  <tr key={u.id}>
                    ...
                    <td style={S.td}><span style={{...S.pill, background:u.role==="ADMIN"?"#FEF3C7":u.role==="EMPLOYER"?"#EFF4FF":"#EAF1FE", color:u.role==="ADMIN"?"#92400E":u.role==="EMPLOYER"?"#1D4ED8":"#6495ED"}}>{u.role}</span></td>
...
const S: Record<string,any> = {
  ...
  brandMark: { width:32, height:32, borderRadius:9, background:"#6495ED", display:"flex", alignItems:"center", justifyContent:"center", fontSize:16 },
  ...
  panelLink: { fontSize:12, color:"#6495ED", textDecoration:"none" },
