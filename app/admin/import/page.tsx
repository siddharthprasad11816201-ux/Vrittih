...
const S: Record<string, any> = {
  body: { padding: "2rem" },
  badge: { display: "inline-flex", alignItems: "center", gap: 6, fontSize: 12.5, fontWeight: 600, color: ACCENT, background: "#EAF1FE", border: "1px solid #E9E4FB", padding: "5px 12px", borderRadius: 999 },
  ...
  code: { display: "block", marginTop: 8, background: "#F7F9FC", border: "1px solid rgba(0,0,0,.06)", borderRadius: 8, padding: "8px 10px", fontSize: 11, color: "#4b5563", fontFamily: "ui-monospace, monospace", lineHeight: 1.5 },
  dropRow: { display: "flex", alignItems: "center", gap: 12, marginBottom: 12, flexWrap: "wrap" as const },
  fileBtn: { display: "inline-flex", alignItems: "center", gap: 7, background: "#EAF1FE", color: ACCENT, border: "1px solid #E9E4FB", borderRadius: 9, padding: "9px 14px", fontSize: 13, fontWeight: 600, cursor: "pointer" },
  fileName: { fontSize: 12.5, color: "#0A0A0F", fontWeight: 500 },
  rowCount: { fontSize: 12, color: "#6b7280", background: "#F7F9FC", padding: "3px 10px", borderRadius: 999 },
  ...
  stat: { flex: "1 1 150px", background: "#F7F9FC", borderRadius: 11, padding: "14px 16px" },
  ...
  posItem: { display: "flex", justifyContent: "space-between", alignItems: "center", background: "#F7F9FC", borderRadius: 9, padding: "9px 13px", fontSize: 13, color: "#0A0A0F" },
  posCount: { fontSize: 12, fontWeight: 700, color: ACCENT, background: "#EAF1FE", padding: "2px 10px", borderRadius: 999 },
