      ...
      {error ? <div style={S.errBox}>{error}<br /><small>Make sure your account role is ADMIN or SUPER_ADMIN.</small></div> : (
        <>
          <div style={S.statsGrid}>
            ...
            <div style={S.statCard}><div style={{ ...S.statNum, color: "#6495ED" }}>{data?.paidCount ?? "—"}</div><div style={S.statLabel}>Paying members</div><div style={S.statSub}>lifetime access</div></div>
