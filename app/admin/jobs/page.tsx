...
.ajChip { display:inline-flex; align-items:center; gap:7px; background:#F1F5F9; border:1px solid transparent; border-radius:999px; padding:7px 14px; font-size:13px; font-weight:500; color:#3D3D4E; cursor:pointer; }
.ajChip.on { background:#6495ED; color:#fff; }
...
.ajErr { margin:2rem; background:#FBEBEB; border:1px solid #E7C9C9; border-radius:12px; padding:1.5rem; font-size:14px; color:#DC2626; text-align:center; }
...
.ajRow:hover { background:#F7F9FC; }
.ajRow.cur { background:#EAF1FE; box-shadow:inset 3px 0 0 #6495ED; }
...
.ajLink { color:#6495ED; font-weight:600; text-decoration:none; }
...
.ajPill.on { background:#EAF1FE; color:#2F6BE0; }
...
.ajBulkBtn { background:#6495ED; color:#fff; border:none; border-radius:9px; padding:8px 15px; font-size:13px; font-weight:600; cursor:pointer; }
.ajBulkBtn.danger { background:#DC2626; }
...
.ajScrim { position:fixed; inset:0; background:rgba(51,78,172,.28); z-index:70; animation:ajFade .2s ease; }
.ajScrim.center { display:grid; place-items:center; }
@keyframes ajFade { from { opacity:0; } }
.ajDrawer { position:fixed; top:0; right:0; height:100vh; width:min(420px,92vw); background:#fff; z-index:71; box-shadow:-20px 0 60px rgba(51,78,172,.18); padding:1.5rem; overflow-y:auto; animation:ajSlide .28s var(--v-ease); }
...
.ajDBtn { display:inline-flex; align-items:center; justify-content:center; gap:7px; background:#6495ED; color:#fff; border:none; border-radius:10px; padding:11px; font-size:13.5px; font-weight:600; cursor:pointer; text-decoration:none; }
.ajDBtn.ghost { background:#fff; border:1px solid rgba(0,0,0,.13); color:#0A0A0F; }
.ajDBtn.danger { background:#fff; border:1px solid rgba(163,45,45,.3); color:#DC2626; }
...
.ajKbd { font-family:var(--font-mono); font-size:12px; background:#F1F5F9; border:1px solid rgba(0,0,0,.1); border-radius:6px; padding:3px 9px; min-width:64px; text-align:center; }
`
