...
const S: Record<string,any> = {
  ...
  shell:{ display:"grid",gridTemplateColumns:"220px 1fr",minHeight:"calc(100dvh - 60px)",overflow:"visible",background:"#F7F9FC" },
  sidebar:{ background:"#0B1126",display:"flex",flexDirection:"column" as const,overflow:"hidden" },
  ...
  createBtn:{ width:"100%",background:"#6495ED",color:"#fff",border:"none",borderRadius:7,padding:"7px",fontSize:12,fontWeight:500,cursor:"pointer" },
  ...
  channelName:{ flex:1 },
  memberDot:{ width:6,height:6,borderRadius:"50%",background:"#6495ED",flexShrink:0 },
  ...
  joinBtn:{ background:"#6495ED",color:"#fff",border:"none",borderRadius:8,padding:"7px 16px",fontSize:13,fontWeight:500,cursor:"pointer" },
  ...
  replyBtn:{ background:"#6495ED",color:"#fff",border:"none",borderRadius:8,padding:"6px 12px",fontSize:12,fontWeight:500,cursor:"pointer" },
  ...
  postBtn:{ width:42,height:42,borderRadius:12,background:"#6495ED",border:"none",color:"#fff",display:"flex",alignItems:"center",justifyContent:"center",cursor:"pointer",flexShrink:0 },
  joinPrompt:{ padding:"1rem 1.5rem",borderTop:"0.5px solid rgba(0,0,0,.07)",textAlign:"center" as const },
  joinPromptBtn:{ background:"#6495ED",color:"#fff",border:"none",borderRadius:9,padding:"10px 24px",fontSize:14,fontWeight:500,cursor:"pointer" },
}
