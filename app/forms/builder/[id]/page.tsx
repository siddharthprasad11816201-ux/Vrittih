...
const S: Record<string, any> = {
  ...
  shareUrl: { flex: 1, fontFamily: "monospace", fontSize: 12.5, color: "#6495ED", minWidth: 160, wordBreak: "break-all" },
  copyBtn: { background: "#EAF1FE", color: "#6495ED", border: "none", borderRadius: 8, padding: "6px 14px", fontSize: 12.5, fontWeight: 600, cursor: "pointer" },
  openBtn: { display: "inline-flex", alignItems: "center", gap: 5, background: "#6495ED", color: "#fff", borderRadius: 8, padding: "6px 14px", fontSize: 12.5, fontWeight: 600, textDecoration: "none" },
  ...
  subContact: { fontSize: 12.5, color: "#6495ED", fontWeight: 600, textDecoration: "none" },
