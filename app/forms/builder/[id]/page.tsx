...
const S: Record<string, any> = {
  ...
  shareUrl: { flex: 1, fontFamily: "monospace", fontSize: 12.5, color: "#534AB7", minWidth: 160, wordBreak: "break-all" },
  copyBtn: { background: "#EEEDF9", color: "#534AB7", border: "none", borderRadius: 8, padding: "6px 14px", fontSize: 12.5, fontWeight: 600, cursor: "pointer" },
  openBtn: { display: "inline-flex", alignItems: "center", gap: 5, background: "#534AB7", color: "#fff", borderRadius: 8, padding: "6px 14px", fontSize: 12.5, fontWeight: 600, textDecoration: "none" },
  ...
  tabOn: { background: "#EEEDF9", color: "#534AB7" },
  ...
  subContact: { fontSize: 12.5, color: "#534AB7", fontWeight: 600, textDecoration: "none" },
