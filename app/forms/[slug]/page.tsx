...
const S: Record<string, any> = {
  ...
  submit: { marginTop: 6, background: "#6495ED", color: "#fff", border: "none", borderRadius: 11, padding: "13px", fontSize: 15, fontWeight: 600, cursor: "pointer" },
  err: { background: "#FEF2F2", border: "1px solid #FECACA", color: "#B91C1C", borderRadius: 9, padding: "10px 13px", fontSize: 13 },
  check: { width: 56, height: 56, borderRadius: "50%", background: "#6495ED", display: "grid", placeItems: "center", margin: "0 auto 6px" },
