...
const S: Record<string, any> = {
  ...
  addBtn: { display: "inline-flex", alignItems: "center", gap: 7, background: "#534AB7", color: "#fff", padding: "10px 16px", borderRadius: 9, fontSize: 14, fontWeight: 600, border: "none", cursor: "pointer" },
  ...
  icon: { width: 40, height: 40, borderRadius: 10, background: "#EEEDF9", color: "#534AB7", display: "grid", placeItems: "center", flexShrink: 0 },
