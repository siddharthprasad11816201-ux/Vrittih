...
const S: Record<string, any> = {
  ...
  addBtn: { display: "inline-flex", alignItems: "center", gap: 7, background: "#6495ED", color: "#fff", padding: "10px 16px", borderRadius: 9, fontSize: 14, fontWeight: 600, border: "none", cursor: "pointer" },
