...
function NetworkInner() {
  ...
  const colors = ["#6495ED","#059669","#B45309","#DC2626","#0891B2","#6495ED"]
                ...
                <div style={S.grid}>
                  {suggestions.map(u => (
                    <div key={u.id} style={S.card}>
                      ...
                      <span style={{...S.rolePill, background:u.role==="EMPLOYER"?"#FEF3C7":"#EFF4FF", color:u.role==="EMPLOYER"?"#92400E":"#6495ED"}}>{u.role}</span>
                      <div style={S.cardActions}>
                        <button
...
const S: Record<string,any> = {
  ...
  tabOn: { background:"#6495ED", color:"#fff", fontWeight:500 },
  ...
  connectBtn: { flex:1, background:"#6495ED", color:"#fff", border:"none", borderRadius:8, padding:"8px 0", fontSize:13, fontWeight:500, cursor:"pointer", transition:"all .15s" },
  connectBtnDone: { background:"#EFF4FF", color:"#6495ED", cursor:"default" },
  acceptBtn: { flex:1, background:"#6495ED", color:"#fff", border:"none", borderRadius:8, padding:"8px 0", fontSize:13, fontWeight:500, cursor:"pointer" },
  ...
  msgBtn: { flex:1, background:"none", border:"0.5px solid rgba(15,110,86,.3)", color:"#6495ED", borderRadius:8, padding:"8px 0", fontSize:13, fontWeight:500, cursor:"pointer" },
