...
const S: Record<string,any> = {
  ...
  lobbyCode:{fontSize:14,fontWeight:700,color:"#B9B2E6",letterSpacing:"2px"},
  ...
  joinBtn:{width:"100%",background:"#534AB7",color:"#fff",border:"none",borderRadius:10,padding:"13px",fontSize:15,fontWeight:600,cursor:"pointer",marginBottom:8},
  ...
  timer:{fontSize:13,color:"#B9B2E6",fontWeight:600,fontVariantNumeric:"tabular-nums"},
  ...
  ctrlBtnOn:{background:"#534AB7",border:"0.5px solid #534AB7"},
  ...
  chatName:{fontWeight:600,color:"#B9B2E6"},
  ...
  chatSend:{background:"#534AB7",color:"#fff",border:"none",borderRadius:8,padding:"6px 12px",fontSize:12,cursor:"pointer"},
}