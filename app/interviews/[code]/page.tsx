...
const S: Record<string,any> = {
  loading:{display:"flex",alignItems:"center",justifyContent:"center",minHeight:"100vh",background:"#0F0A1E",color:"#fff",fontSize:14},
  lobby:{minHeight:"100vh",background:"#0F0A1E",display:"flex",alignItems:"center",justifyContent:"center",padding:"2rem"},
  ...
  lobbyCode:{fontSize:14,fontWeight:700,color:"#C4B5FD",letterSpacing:"2px"},
  ...
  joinBtn:{width:"100%",background:"#7C3AED",color:"#fff",border:"none",borderRadius:10,padding:"13px",fontSize:15,fontWeight:600,cursor:"pointer",marginBottom:8},
  ...
  room:{display:"flex",flexDirection:"column" as const,height:"100vh",background:"#0F0A1E",overflow:"hidden"},
  ...
  timer:{fontSize:13,color:"#C4B5FD",fontWeight:600,fontVariantNumeric:"tabular-nums"},
  ...
  ctrlBtnOn:{background:"#7C3AED",border:"0.5px solid #7C3AED"},
  ...
  chatName:{fontWeight:600,color:"#C4B5FD"},
  ...
  chatSend:{background:"#7C3AED",color:"#fff",border:"none",borderRadius:8,padding:"6px 12px",fontSize:12,cursor:"pointer"},
}