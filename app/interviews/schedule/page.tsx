...
const S: Record<string,any> = {
  ...
  typeCardOn:{border:"1.5px solid #7C3AED",background:"#F5F3FF"},
  typeLabel:{fontSize:13,fontWeight:600,color:"#0A0A0F",marginBottom:3},
  typeDesc:{fontSize:11,color:"#9ca3af"},
  row:{display:"flex",gap:12},
  addRow:{display:"flex",gap:8},
  addBtn:{background:"#7C3AED",color:"#fff",border:"none",borderRadius:8,padding:"8px 16px",fontSize:13,cursor:"pointer",flexShrink:0},
  ...
  pAvatar:{width:32,height:32,borderRadius:"50%",background:"#7C3AED",color:"#fff",display:"flex",alignItems:"center",justifyContent:"center",fontSize:13,fontWeight:600,flexShrink:0},
  removeBtn:{background:"none",border:"none",fontSize:18,color:"#9ca3af",cursor:"pointer"},
  submitBtn:{width:"100%",background:"#7C3AED",color:"#fff",border:"none",borderRadius:9,padding:"12px",fontSize:14,fontWeight:600,cursor:"pointer",marginTop:4},
}