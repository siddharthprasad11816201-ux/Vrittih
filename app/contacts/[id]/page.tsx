...
const S: Record<string, any> = {
  ...
  dot: { width: 9, height: 9, borderRadius: "50%", background: "#534AB7", marginTop: 5, flexShrink: 0 },
  ...
  composerInput: { flex: 1, border: "1px solid #E1E0E7", borderRadius: 10, padding: "11px 14px", fontSize: 14, outline: "none", color: "#1A1A2E" },
  ...
  sendBtn: { background: "#534AB7", color: "#fff", border: "none", borderRadius: 10, padding: "0 22px", fontSize: 14, fontWeight: 600, cursor: "pointer" },
