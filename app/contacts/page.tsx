...
const S: Record<string, any> = {
  ...
  addBtn: { display: "inline-flex", alignItems: "center", gap: 7, background: "#534AB7", color: "#fff", padding: "10px 16px", borderRadius: 9, fontSize: 14, fontWeight: 600, textDecoration: "none" },
  ...
  chipOn: { background: "#EEEDF9", color: "#534AB7", borderColor: "#EEEDF9" },
