...
export default function NotificationBell() {
  ...
  function getIcon(title: string) {
    ...
    if (t.includes("application") || t.includes("applied")) return { icon: <IconFileText size={15} />, color: "#6495ED" }
...
const S: Record<string,any> = {
  ...
  dropBtn: { background:"none", border:"none", fontSize:12, color:"#6495ED", cursor:"pointer", padding:"3px 6px" },
  ...
  unreadDot: { width:8, height:8, borderRadius:"50%", background:"#6495ED", flexShrink:0, marginTop:4 },
  dropFoot: { padding:"10px 16px", borderTop:"0.5px solid rgba(0,0,0,.07)", textAlign:"center" as const },
  viewAll: { fontSize:13, color:"#6495ED", textDecoration:"none", fontWeight:500 },
}