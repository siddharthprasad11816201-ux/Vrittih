...
export default function NotificationBell() {
  ...
  function getIcon(title: string) {
    ...
    if (t.includes("application") || t.includes("applied")) return { icon: <IconFileText size={15} />, color: "#7C3AED" }
...
const S: Record<string,any> = {
  ...
  dropBtn: { background:"none", border:"none", fontSize:12, color:"#7C3AED", cursor:"pointer", padding:"3px 6px" },
  ...
  itemUnread: { background:"rgba(124,58,237,.04)" },
  ...
  unreadDot: { width:8, height:8, borderRadius:"50%", background:"#7C3AED", flexShrink:0, marginTop:4 },
  dropFoot: { padding:"10px 16px", borderTop:"0.5px solid rgba(0,0,0,.07)", textAlign:"center" as const },
  viewAll: { fontSize:13, color:"#7C3AED", textDecoration:"none", fontWeight:500 },
}