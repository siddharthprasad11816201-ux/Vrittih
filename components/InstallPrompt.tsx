...
const S: Record<string, any> = {
  wrap: { position: "fixed", left: "50%", bottom: 18, transform: "translateX(-50%)", zIndex: 90, width: "min(460px, calc(100vw - 24px))",
    ...
    background: "linear-gradient(150deg,#6495ED,#0B1126)", color: "#EAF1FE", boxShadow: "0 18px 50px rgba(51,78,172,.4)", fontFamily: "var(--font-sans)" },
  ...
  install: { background: "#fff", color: "#2F6BE0", border: "none", borderRadius: 10, padding: "9px 18px", fontSize: 13.5, fontWeight: 700, cursor: "pointer", flexShrink: 0 },
  later: { background: "rgba(255,255,255,.12)", color: "#EAF1FE", border: "none", borderRadius: 9, padding: 8, cursor: "pointer", display: "flex", flexShrink: 0 },
}
